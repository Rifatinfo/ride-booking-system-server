...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedPayment = yield payment_model_1.Payment.findOneAndUpdate({ transactionId: query.transactionId }, {
            paymentStatus: payment_interface_1.PAYMENT_STATUS.PAID,
        }, { new: true, runValidators: true, session: session });
        if (!updatedPayment) {
            throw new AppError_1.default(404, "Payment not found");
        }
        // ✅ Update Ride
        const updatedRide = yield ride_model_1.Ride.findByIdAndUpdate(updatedPayment.ride, { status: "PAYMENT_COMPLETE", payment: updatedPayment._id }, { new: true, runValidators: true, session })
